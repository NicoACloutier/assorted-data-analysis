...
def main():
    ...
    text_df = pd.read_csv('data\\train.csv', encoding='utf8') #read sentence list
    ...
    chengyu = pd.read_csv('data\\all-chengyu.csv') #get list of all chengyu
    ...
    final_chengyu.to_csv('data\\chengyu-appearances.csv') #write to csv
